...
userRoute.get("/", (0, auth_1.auth)([user_interface_1.Role.ADMIN, user_interface_1.Role.SENDER]), user_controller_1.getUsers);
userRoute.get("/:id", auth_1.auth, user_controller_1.getSingleUser);
